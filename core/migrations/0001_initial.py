# Generated by Django 3.0.5 on 2020-04-10 17:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cargo', models.CharField(max_length=79, verbose_name='Cargo')),
            ],
            options={
                'verbose_name': 'Cargo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icone', models.CharField(choices=[('lni-cog', 'Engrenagem'), ('lni-stats-up', 'Grafico'), ('lni-users', 'Usuarios'), ('lni-layers', 'Camadas'), ('lni-mobile', 'Mobile'), ('lni-rocket', 'Foguete')], max_length=15, verbose_name='Icone')),
            ],
            options={
